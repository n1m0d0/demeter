<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    ...
                    <x-jet-nav-link href="{{ route('page.subcategory') }}" :active="request()->routeIs('page.subcategory')">
                        Subcategoria
                    </x-jet-nav-link>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <x-jet-responsive-nav-link href="{{ route('page.subcategory') }}" :active="request()->routeIs('page.subcategory')">
                Subcategoria
            </x-jet-responsive-nav-link>
            <x-jet-responsive-nav-link href="{{ route('page.product') }}" :active="request()->routeIs('page.product')">
                Producto
            </x-jet-responsive-nav-link>
            ...
            <x-jet-responsive-nav-link href="{{ route('page.control') }}" :active="request()->routeIs('page.control')">
                Control
            </x-jet-responsive-nav-link>
