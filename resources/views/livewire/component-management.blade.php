                                ...
                                <tr class="bg-blue-200 text-black">
                                    ...
                                    <td class="p-3 flex gap-1 items-center">
                                        <x-tooltip tooltip="Editar">
                                            <a wire:click='edit({{ $order->id }})' class="cursor-pointer">
                                                <x-fas-edit class="w-6 h-6 text-green-500 hover:text-gray-100" />
                                            </a>
                                        </x-tooltip>
        ...
        <x-template_order>
                                    ...
                                    <tr class="bg-blue-200 text-black">
                                        ...
                                        <td class="p-3 flex gap-1 items-center">
                                            <x-tooltip tooltip="Elegir">
                                                <a wire:click='pickProduct({{ $product->id }})'
            ...
            <x-slot name='body2'>
                @if ($step == 1)
                    ...
                    <div class="m-2">
                        <x-jet-label for="deliveryOld" value="Fecha de Entrega Anterior" />
                        <x-jet-input id="deliveryOld" type="text" class="mt-1 block w-full"
                            wire:model='deliveryOld' disabled="true" />
                            <x-jet-label for="delivery" value="Fecha de Entrega nueva" />
                ...
                @if ($step == 2)
                    ...
                    <div class="m-2">
                        ...
                        <x-jet-input id="price" type="number" class="mt-1 block w-full" step="0.01"
                            wire:model='price' />
                                                ...
                                                @foreach ($detail->personalizations as $personalization)
                                                    @if ($personalization->status == 1)
                                                        <ul>
                                                            <li>
                                                                <div
                                                                    class="flex justify-start items-center mt-2 gap-2">
                                                                    {{ $personalization->description }}
                                                                    @if ($personalization->image != null)
                                                                        <img src="{{ Storage::url($personalization->image) }}"
                                                                            class="rounded-full h-10 w-10 object-cover">
                                                                    ...
                                                                    <x-tooltip tooltip="Eliminar">
                                                                        <a wire:click='deletePersonalization({{ $personalization->id }})'
                                                                            class="cursor-pointer">
                                                                            <x-fas-trash-can
                                                                                class="w-6 h-6 text-red-500 hover:text-gray-100" />
                                                                        </a>
                                                                    </x-tooltip>
                                                                </div>
                                                            </li>
